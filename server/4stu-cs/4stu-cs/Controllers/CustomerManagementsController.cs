...
//        [HttpGet]
//        public async Task<ActionResult<IEnumerable<UserManagement>>> GetCustomerManagements()
//        {
...
//        [HttpGet("{id}")]
//        public async Task<ActionResult<UserManagement>> GetCustomerManagement(int id)
//        {
//            if (_context.UserManagements == null)
//            {
//                return NotFound();
//            }
//            var customerManagement = await _context.UserManagements.FindAsync(id);
...
//        [HttpPut("{id}")]
//        public async Task<IActionResult> PutCustomerManagement(int id, UserManagement userManagement)
//        {
...
//        {
//            public UserManagement Customer { get; set; }
//            public string AccessToken { get; set; }
//        }

//        private string GenerateToken(UserManagement customer)
//        {
...
//            {
//                if (CustomerManagementExists(customerManagement.UserId))
//                {
//                    return Conflict();
//                }
//                else
...
//            _context.UserManagements.Remove(customerManagement);
//            await _context.SaveChangesAsync();
...
//        {
//            return _context.UserManagements.Any(e => e.UserId == id);
//        }
//    }
//}
